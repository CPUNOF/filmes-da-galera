  ...
  useEffect(() => {
    async function carregarDados() {
      try {
        ...
        // 🪄 Pegando APENAS AS 4 sugestões mais votadas para a linha do topo
  ...
  return (
    <div className="relative min-h-screen pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 mt-6 sm:mt-10 relative z-30">
        ...
        {/* 🔥 NOVA ESTRUTURA: SUGESTÕES NO TOPO */}
          ...
          <div className="mb-16 sm:mb-24">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-6 sm:mb-8 gap-3 sm:gap-4">
              <div>
                ...
                <p className="text-gray-500 text-[9px] sm:text-[10px] mt-1 sm:mt-2 font-black uppercase tracking-[0.2em]">Os 4 mais votados para a próxima sessão</p>
              </div>
        ...
        {/* 🎬 DIVISÓRIA PREMIUM E ACERVO DE ASSISTIDOS */}
        <div className="pt-10 sm:pt-16 border-t border-white/5">
          ...
          <div className="mb-6 sm:mb-10">
            ...
            <p className="text-gray-500 text-[9px] sm:text-[10px] mt-1 sm:mt-2 font-black uppercase tracking-[0.2em]">O que já vimos e avaliamos no grupo</p>
          </div>
          ...
          {!carregando && filmesExibidos.length === 0 && (
            <div className="py-16 sm:py-20 text-center border border-dashed border-white/5 rounded-3xl mt-6 sm:mt-8">
              ...
              <p className="text-gray-500 text-[9px] sm:text-[10px] font-black uppercase tracking-widest">Nenhum filme corresponde à busca no acervo.</p>
            </div>
          )}
        </div>
